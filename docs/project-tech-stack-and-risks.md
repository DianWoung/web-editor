...
- `apps/twin-web`：前端主应用，负责场景运营工作台、场景编排、运行态总览、预览与设备详情展示
...
- 前端已把顶层界面收敛为场景运营中台：场景作为一级主对象，`/assets` 下沉为配置入口，`编辑 / 预览 / 总览` 统一为场景子工作区语法
